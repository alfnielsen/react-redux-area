...
export declare const CreateDispatchActionsObject: <T extends Record<keyof T, MethodWithActionName>>(actionCreatorListObject: T) => IDispatchActionObject<T>;
export declare const CreateAreaHook: <T extends Record<keyof T, MethodWithActionName>, TReduxStoreState, TAreaState>(areaActions: T, selector: (state: TReduxStoreState) => TAreaState) => TAreaState & IDispatchActionObject<T>;
